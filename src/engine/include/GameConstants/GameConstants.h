...
struct GameConstants
{
    ...
    static constexpr const char* DEFAULT_MAP_PATH = "assets/maps/test_stage.json";
    ...
    static constexpr const char* DEFAULT_CHARACTER_DEF_PATH = "assets/characters/knight.json";
};
