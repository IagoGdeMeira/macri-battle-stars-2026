...
TEST_CASE("EntityManager can assign unique IDs", "[unit][entity_manager]")
{
    EntityManager manager;
...
TEST_CASE("EntityManager can destroy entities", "[unit][entity_manager]")
{
    EntityManager manager;
    Entity e = manager.create();
...
TEST_CASE("EntityManager can reuse IDs of destroyed entities", "[unit][entity_manager]")
{
    EntityManager manager;
...
TEST_CASE("EntityManager can destroy an entity twice without crashing", "[unit][entity_manager]")
{
    EntityManager manager;
...
TEST_CASE("Invalid entities are not alive", "[unit][entity_manager]")
{
    EntityManager manager;
...
TEST_CASE("EntityManager can handle multiple entities' lifecycles", "[unit][entity_manager]")
{
    EntityManager manager;
...
TEST_CASE("EntityManager can handle a large number of entities", "[unit][entity_manager]")
{
    EntityManager manager;
