#include "../../../src/game/render_formats/RectangleRenderFormat.h"
...
class RectangleRenderFormatFixture
{
public:
    ...
    RectangleRenderFormatFixture() : format(this->renderer), context { this->world, this->bus }
    {
    ...
    RectangleRenderFormat format;
    RenderContext context;
};

TEST_CASE_METHOD(RectangleRenderFormatFixture, "RectangleRenderFormat submits base and visual effect commands",
